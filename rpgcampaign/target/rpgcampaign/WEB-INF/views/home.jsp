	...
	<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
		<div
			...
			<a href="#" class="w3-bar-item w3-button"
				...
				href="/rpg-campaign/gameplay?action=UserPage" class="w3-bar-item w3-button"
				style="width: 25% !important">USUARIOS</a> <a
				href="/rpg-campaign/gameplay?action=CampaignPage" class="w3-bar-item w3-button"
	...
	<div class="w3-padding-large" id="main">
		...
		<div class="w3-content w3-justify w3-text-grey w3-padding-64"
			...
			<p>Depois disso, e so entrar na sua nova campanha e gerenciar a
				mesa de jogo!</p>
				<p><a href="/users/form" class="w3-bar-item w3-button"
				style="width: 25% !important">Criar Usuário</a></p>
				<p><a href="/rpg-campaign/gameplay?action=LoginForm" class="w3-bar-item w3-button"
				style="width: 25% !important">Fazer Login</a></p>
			<!-- End About Section -->
